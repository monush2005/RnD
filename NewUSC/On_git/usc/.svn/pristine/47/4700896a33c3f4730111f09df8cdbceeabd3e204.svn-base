...
import in.spicedigital.umang.dto.request.FetchSummaryReqPojo;
...
public class SummaryController {
	...
	@RequestMapping(value = RestURIConstants.REST_POST_SUMMARY, method = RequestMethod.POST)
		public @ResponseBody String  login(@RequestBody FetchSummaryReqPojo requestBody,HttpSession session) {
			...
			try {
				...
				logger.info("URL: {}",WsConstants.WS_APPLICATION_URL+RestServiceURIConstants.REST_POST_SUMMARY);
				response = restTemplate.postForEntity(WsConstants.WS_APPLICATION_URL+RestServiceURIConstants.REST_POST_SUMMARY, entity,String.class);
