...
import in.spicedigital.umang.dto.request.UpdateUserReqPojo;
...
public class UpdateUserController {
	...
	@RequestMapping(value = RestURIConstants.REST_POST_UPDATE_USER, method = RequestMethod.POST)
		public @ResponseBody String  login(@RequestBody UpdateUserReqPojo requestBody,HttpSession session) {
			...
			try {
				...
				logger.info("URL: {}",WsConstants.WS_APPLICATION_URL+RestServiceURIConstants.REST_POST_UPDATE_USER);
				response = restTemplate.postForEntity(WsConstants.WS_APPLICATION_URL+RestServiceURIConstants.REST_POST_UPDATE_USER, entity,String.class);
