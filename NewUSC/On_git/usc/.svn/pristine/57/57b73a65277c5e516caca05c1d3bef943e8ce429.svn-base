...
import in.spicedigital.umang.dto.request.ResetPasswordReqPojo;
...
public class ResetPasswordController {
	...
	@RequestMapping(value = RestURIConstants.REST_POST_RESET_PASS, method = RequestMethod.POST)
		public @ResponseBody String  login(@RequestBody ResetPasswordReqPojo requestBody,HttpSession session) {
			...
			try {
				...
				logger.info("URL: {}",WsConstants.WS_APPLICATION_URL+RestServiceURIConstants.REST_POST_RESET_PASS);
				response = restTemplate.postForEntity(WsConstants.WS_APPLICATION_URL+RestServiceURIConstants.REST_POST_RESET_PASS, entity,String.class);
