...
public class GenrateOtpRequestPojo {
	...
	public String toString() {
		return "GenrateOtpPERequestPojo [mno=" + mno + ", did=" + did + ", imsi=" + imsi + ", lang=" + lang + ", st=" + st + ", ver=" + ver + ", hmk=" + hmk + ", hmd=" + hmd + ", mcc=" + mcc + ", mnc=" + mnc + ", clid=" + clid + ", peml=" + peml + ", mod=" + mod + ", ort=" + ort + ", dgt=" + dgt + ", os=" + os + ", chnl=" + chnl + ", trkr=" + trkr + ", uid=" + uid + ", uname=" + uname + "]";
	}
