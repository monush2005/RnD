var envVars = {}
envVars.base = '';
envVars.apiServer = 'http://localhost:8080';
envVars.debugInfo = true;
envVars.serverTimeout = 60 * 60 * 1000;
envVars.xhrTimeout = 15 * 10000;
envVars.analyticsStartDate = new Date(2017, 0, 1);
...
envVars.ga = {};
envVars.ga.apiKey = 'AIzaSyCix2u2mNql6mQpENPe-li3BDQfae87mYo';
envVars.ga.clientId = '616074837787-tocasdb3ragvpa3tbv6u3rjol8rfja78.apps.googleusercontent.com';
