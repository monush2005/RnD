(function(app) {
    'use strict';
    app.component('viewattachmentcomponent', {
        templateUrl: 'resources/app/components/userQueryComponent/emailViewComponent/viewattachmentcomponent.html',
    ...
    function emailViewComponentController($localStorage, $mdDialog, userQueryService) {
        ...
        function saveQueryStatus() {
            vm.saveQueryPromise = userQueryService.saveQueryStatus({
                ...
                attachment:vm.emailData.attachment
