...
import in.spicedigital.umang.usc.request.ChangeRequestReqPojo;
...
public class ChangeRequestController {
	...
	@RequestMapping(value = "/reqChange", method = RequestMethod.POST)
	public @ResponseBody String changeRequest(@RequestBody ChangeRequestReqPojo requestBody,HttpSession session,HttpServletRequest request) {
		...
		try {
			...
			return restTemplate.postForEntity(RestServiceURIConstants.REST_POST_USC_CHANGE_REQUEST,requestJson,request,encryptionUtility.getReadTimeout(),encryptionUtility.getConnectionTimeout());
		} catch (Exception e) {
			e.printStackTrace();
