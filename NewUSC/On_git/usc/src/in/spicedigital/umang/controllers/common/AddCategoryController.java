...
import in.spicedigital.umang.dto.request.AddCategoryReqPojo;
...
public class AddCategoryController {
	...
	@RequestMapping(value = RestURIConstants.REST_POST_ADD_CATEGORY, method = RequestMethod.POST)
		public @ResponseBody String  login(@RequestBody AddCategoryReqPojo requestBody,HttpSession session){
			...
			try {
				...
				logger.info("URL: {}",WsConstants.WS_APPLICATION_URL+RestServiceURIConstants.REST_POST_ADD_CATEGORY);
				response = restTemplate.postForEntity(WsConstants.WS_APPLICATION_URL+RestServiceURIConstants.REST_POST_ADD_CATEGORY, entity,String.class);
