...
import in.spicedigital.umang.dto.request.AddUserRightsReqPojo;
import in.spicedigital.umang.utility.Utility;
@Controller
public class AddRightsController {
	
	private final Logger logger = LoggerFactory.getLogger(this.getClass());
	@Autowired
	private Utility encryptionUtility;

	@RequestMapping(value = RestURIConstants.REST_POST_ADD_RIGHTS, method = RequestMethod.POST)
		public @ResponseBody String  login(@RequestBody AddUserRightsReqPojo requestBody,HttpSession session) {
			...
			try {
				...
				logger.info("URL: {}",WsConstants.WS_APPLICATION_URL+RestServiceURIConstants.REST_POST_ADD_RIGHTS);
				response = restTemplate.postForEntity(WsConstants.WS_APPLICATION_URL+RestServiceURIConstants.REST_POST_ADD_RIGHTS, entity,String.class);
