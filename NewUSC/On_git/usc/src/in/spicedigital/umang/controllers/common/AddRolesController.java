...
public class AddRolesController {
	...
	@RequestMapping(value = RestURIConstants.REST_POST_ADD_ROLES, method = RequestMethod.POST)
		public @ResponseBody String  login(@RequestBody AddRolesReqPojo requestBody,HttpSession session) {
			...
			try {
				...
				logger.info("URL: {}",WsConstants.WS_APPLICATION_URL+RestServiceURIConstants.REST_POST_ADD_ROLES);
				response = restTemplate.postForEntity(WsConstants.WS_APPLICATION_URL+RestServiceURIConstants.REST_POST_ADD_ROLES, entity,String.class);
