...
@Controller
public class AppServicesRatingController {
	private final Logger logger = LoggerFactory.getLogger(this.getClass());
	@Autowired
	private Utility encryptionUtility;

	@RequestMapping(value = RestURIConstants.REST_APP_SERVICES_RATING, method = RequestMethod.POST)
		public @ResponseBody String  login(@RequestBody AppServicesRatingPojo requestBody,HttpSession session) {
			...
			try {
				...
				logger.info("URL: {}",WsConstants.WS_APPLICATION_URL+RestServiceURIConstants.REST_POST_APP_SERVICES_RATING);
				response = restTemplate.postForEntity(WsConstants.WS_APPLICATION_URL+RestServiceURIConstants.REST_POST_APP_SERVICES_RATING, entity,String.class);
