...
import in.spicedigital.umang.dto.request.DelDeptReqPojo;
import in.spicedigital.umang.dto.request.RequestBannerApprovalReqPojo;
import in.spicedigital.umang.utility.Utility;

@Controller
public class BannerApprovalController {
	...
	@RequestMapping(value = RestURIConstants.REST_POST_APPROVE_BANNER, method = RequestMethod.POST)
		public @ResponseBody String  login(@RequestBody RequestBannerApprovalReqPojo requestBody,HttpSession session) {
			...
			try {
				...
				logger.info("URL: {}",WsConstants.WS_APPLICATION_URL+RestServiceURIConstants.REST_POST_BANNER_FETCH_APPROVALS);
				response = restTemplate.postForEntity(WsConstants.WS_APPLICATION_URL+RestServiceURIConstants.REST_POST_BANNER_FETCH_APPROVALS, entity,String.class);
