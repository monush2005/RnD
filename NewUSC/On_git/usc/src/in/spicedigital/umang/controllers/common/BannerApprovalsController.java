...
import in.spicedigital.umang.dto.request.FetchBannerApprovalsReqPojo;
import in.spicedigital.umang.utility.Utility;

@Controller
public class BannerApprovalsController {
	...
	@RequestMapping(value = RestURIConstants.REST_POST_FETCHAPPROVE_BANNER, method = RequestMethod.POST)
		public @ResponseBody String  login(@RequestBody FetchBannerApprovalsReqPojo requestBody,HttpSession session) {
			...
			try {
				...
				logger.info("URL: {}",WsConstants.WS_APPLICATION_URL+RestServiceURIConstants.REST_POST_FETCHAPPROVE_BANNER);
				response = restTemplate.postForEntity(WsConstants.WS_APPLICATION_URL+RestServiceURIConstants.REST_POST_FETCHAPPROVE_BANNER, entity,String.class);
