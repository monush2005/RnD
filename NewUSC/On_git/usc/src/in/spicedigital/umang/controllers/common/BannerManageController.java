...
import in.spicedigital.umang.dto.request.ManagerBannerReqPojo;
...
public class BannerManageController {
	...
	@RequestMapping(value = RestURIConstants.REST_POST_MANAGE_BANNER, method = RequestMethod.POST)
		public @ResponseBody String  login(@RequestBody ManagerBannerReqPojo requestBody,HttpSession session) {
			...
			try {
				...
				logger.info("URL: {}",WsConstants.WS_APPLICATION_URL+RestServiceURIConstants.REST_POST_MANAGE_BANNER);
				response = restTemplate.postForEntity(WsConstants.WS_APPLICATION_URL+RestServiceURIConstants.REST_POST_MANAGE_BANNER, entity,String.class);
