...
public class BannerViewController {
	...
	@RequestMapping(value = RestURIConstants.REST_POST_VIEW_BANNER, method = RequestMethod.POST)
		public @ResponseBody String  login(@RequestBody ViewBannerReqPojo requestBody,HttpSession session) {
			...
			try {
				...
				logger.info("URL: {}",WsConstants.WS_APPLICATION_URL+RestServiceURIConstants.REST_POST_VIEW_BANNER);
				response = restTemplate.postForEntity(WsConstants.WS_APPLICATION_URL+RestServiceURIConstants.REST_POST_VIEW_BANNER, entity,String.class);
