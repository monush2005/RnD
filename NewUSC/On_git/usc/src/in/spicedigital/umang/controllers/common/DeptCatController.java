...
import in.spicedigital.umang.dto.request.ViewBannerReqPojo;
import in.spicedigital.umang.utility.Utility;
@Controller
public class DeptCatController {
	...
	@RequestMapping(value = RestURIConstants.REST_POST_DEPT_CAT, method = RequestMethod.POST)
		public @ResponseBody String  login(@RequestBody FetchDeptCategoryReqPojo requestBody,HttpSession session) {
			...
			try {
				...
				logger.info("URL: {}",WsConstants.WS_APPLICATION_URL+RestServiceURIConstants.REST_POST_Department_Category);
				response = restTemplate.postForEntity(WsConstants.WS_APPLICATION_URL+RestServiceURIConstants.REST_POST_Department_Category, entity,String.class);
