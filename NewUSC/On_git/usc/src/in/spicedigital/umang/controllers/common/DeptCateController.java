...
import in.spicedigital.umang.dto.request.DeptCategoryReqPojo;
import in.spicedigital.umang.dto.request.FetchDeptCategoryReqPojo;
import in.spicedigital.umang.utility.Utility;
@Controller
public class DeptCateController {
	...
	@RequestMapping(value = RestURIConstants.REST_POST_DEPT_CATEG, method = RequestMethod.POST)
		public @ResponseBody String  login(@RequestBody DeptCategoryReqPojo requestBody,HttpSession session) {
			...
			try {
				...
				logger.info("URL: {}",WsConstants.WS_APPLICATION_URL+RestServiceURIConstants.REST_POST_WITHOUT_Department_Category);
				response = restTemplate.postForEntity(WsConstants.WS_APPLICATION_URL+RestServiceURIConstants.REST_POST_WITHOUT_Department_Category, entity,String.class);
