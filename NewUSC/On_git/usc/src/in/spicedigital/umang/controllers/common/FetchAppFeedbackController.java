...
@Controller
public class FetchAppFeedbackController {
	
	private final Logger logger = LoggerFactory.getLogger(this.getClass());
	@Autowired
	private Utility encryptionUtility;

	@RequestMapping(value = RestURIConstants.REST_POST_FETCH_APP_FEEDBACK, method = RequestMethod.POST)
		public @ResponseBody String  login(@RequestBody FetchAppFeedbackPojo	 requestBody,HttpSession session) {
			...
			try {
				...
				logger.info("URL: {}",WsConstants.WS_APPLICATION_URL+RestServiceURIConstants.REST_POST_FETCH_APP_FEEDBACK);
				response = restTemplate.postForEntity(WsConstants.WS_APPLICATION_URL+RestServiceURIConstants.REST_POST_FETCH_APP_FEEDBACK, entity,String.class);
