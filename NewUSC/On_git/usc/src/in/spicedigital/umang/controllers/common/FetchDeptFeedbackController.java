...
@Controller
public class FetchDeptFeedbackController {
	
	private final Logger logger = LoggerFactory.getLogger(this.getClass());
	@Autowired
	private Utility encryptionUtility;

	@RequestMapping(value = RestURIConstants.REST_POST_FETCH_DEPT_FEEDBACK, method = RequestMethod.POST)
		public @ResponseBody String  login(@RequestBody FetchDeptFeedbackPojo	 requestBody,HttpSession session) {
			...
			try {
				...
				logger.info("URL: {}",WsConstants.WS_APPLICATION_URL+RestServiceURIConstants.REST_POST_FETCH_DEPT_FEEDBACK);
				response = restTemplate.postForEntity(WsConstants.WS_APPLICATION_URL+RestServiceURIConstants.REST_POST_FETCH_DEPT_FEEDBACK, entity,String.class);
