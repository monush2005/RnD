...
import in.spicedigital.umang.dto.request.FetchDeptFaqReqPojo;
import in.spicedigital.umang.utility.Utility;
@Controller
public class FetchDerpartmentFaqController {
	
	private final Logger logger = LoggerFactory.getLogger(this.getClass());
	@Autowired
	private Utility encryptionUtility;

	@RequestMapping(value = RestURIConstants.REST_POST_DEPTT_FAQ, method = RequestMethod.POST)
		public @ResponseBody String  login(@RequestBody FetchDeptFaqReqPojo requestBody,HttpSession session) {
			...
			try {
				...
				logger.info("URL: {}",WsConstants.WS_APPLICATION_URL+RestServiceURIConstants.REST_POST_DEPTT_FAQ);
				response = restTemplate.postForEntity(WsConstants.WS_APPLICATION_URL+RestServiceURIConstants.REST_POST_DEPTT_FAQ, entity,String.class);
