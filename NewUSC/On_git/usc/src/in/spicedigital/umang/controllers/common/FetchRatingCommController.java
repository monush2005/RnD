...
@Controller
public class FetchRatingCommController {
	
	private final Logger logger = LoggerFactory.getLogger(this.getClass());
	@Autowired
	private Utility encryptionUtility;

	@RequestMapping(value = RestURIConstants.REST_POST_FETCH_RATING_COMM, method = RequestMethod.POST)
		public @ResponseBody String  login(@RequestBody FetchRatingCommentsReqPojo	 requestBody,HttpSession session) {
			...
			try {
				...
				logger.info("URL: {}",WsConstants.WS_APPLICATION_URL+RestServiceURIConstants.REST_POST_FETCH_RATING_COMM);
				response = restTemplate.postForEntity(WsConstants.WS_APPLICATION_URL+RestServiceURIConstants.REST_POST_FETCH_RATING_COMM, entity,String.class);
