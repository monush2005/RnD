...
import in.spicedigital.umang.dto.request.FetchRatingReqPojo;
...
public class FetchRatingController {
	...
	@RequestMapping(value = RestURIConstants.REST_POST_FETCH_RATING, method = RequestMethod.POST)
		public @ResponseBody String  login(@RequestBody FetchRatingReqPojo requestBody,HttpSession session) {
			...
			try {
				...
				logger.info("URL: {}",WsConstants.WS_APPLICATION_URL+RestServiceURIConstants.REST_POST_FETCH_RATING);
				response = restTemplate.postForEntity(WsConstants.WS_APPLICATION_URL+RestServiceURIConstants.REST_POST_FETCH_RATING, entity,String.class);
