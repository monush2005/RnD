...
import in.spicedigital.umang.dto.request.ForgetPasswordReqPojo;
...
public class ForgotPwdController {
	...
	@RequestMapping(value = RestURIConstants.REST_POST_FORGOT_PWD, method = RequestMethod.POST)
		public @ResponseBody String  login(@RequestBody ForgetPasswordReqPojo requestBody,HttpSession session) {
			...
			try {
				...
				logger.info("URL: {}",WsConstants.WS_APPLICATION_URL+RestServiceURIConstants.REST_POST_FORGOT_PWD);
				response = restTemplate.postForEntity(WsConstants.WS_APPLICATION_URL+RestServiceURIConstants.REST_POST_FORGOT_PWD, entity,String.class);
