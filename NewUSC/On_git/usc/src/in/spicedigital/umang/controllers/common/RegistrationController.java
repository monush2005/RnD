...
import in.spicedigital.umang.dto.request.RegisterNewUserReqPojo;
...
public class RegistrationController {
	...
	@RequestMapping(value = RestURIConstants.REST_POST_REG, method = RequestMethod.POST)
		public @ResponseBody String  login(@RequestBody RegisterNewUserReqPojo requestBody,HttpSession session) {
			...
			try {
				...
				logger.info("URL: {}",WsConstants.WS_APPLICATION_URL+RestServiceURIConstants.REST_POST_REG);
				response = restTemplate.postForEntity(WsConstants.WS_APPLICATION_URL+RestServiceURIConstants.REST_POST_REG, entity,String.class);
