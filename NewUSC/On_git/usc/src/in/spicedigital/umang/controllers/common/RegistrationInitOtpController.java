...
import in.spicedigital.umang.dto.request.InitOtpReqPojo;
import in.spicedigital.umang.utility.Utility;
@Controller
public class RegistrationInitOtpController {
	
	private final Logger logger = LoggerFactory.getLogger(this.getClass());
	@Autowired
	private Utility encryptionUtility;

	@RequestMapping(value = RestURIConstants.REST_POST_REG_INIT, method = RequestMethod.POST)
		public @ResponseBody String  login(@RequestBody InitOtpReqPojo requestBody,HttpSession session) {
			...
			try {
				...
				logger.info("URL: {}",WsConstants.WS_APPLICATION_URL+RestServiceURIConstants.REST_POST_REG_INIT);
				response = restTemplate.postForEntity(WsConstants.WS_APPLICATION_URL+RestServiceURIConstants.REST_POST_REG_INIT, entity,String.class);
