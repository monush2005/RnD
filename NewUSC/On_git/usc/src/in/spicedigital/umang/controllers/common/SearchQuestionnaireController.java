...
import in.spicedigital.umang.dto.request.SearchQuestionnaireReqPojo;
...
public class SearchQuestionnaireController {
	...
	@RequestMapping(value = RestURIConstants.REST_POST_QUESTIONNAIRE_SEARCH, method = RequestMethod.POST)
		public @ResponseBody String  login(@RequestBody SearchQuestionnaireReqPojo requestBody,HttpSession session) {
			...
			try {
				...
				logger.info("URL: {}",WsConstants.WS_APPLICATION_URL+RestServiceURIConstants.REST_POST_QUESTIONNAIRE_SEARCH);
				response = restTemplate.postForEntity(WsConstants.WS_APPLICATION_URL+RestServiceURIConstants.REST_POST_QUESTIONNAIRE_SEARCH, entity,String.class);
