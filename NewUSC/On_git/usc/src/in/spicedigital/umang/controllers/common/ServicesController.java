...
import in.spicedigital.umang.dto.request.FetchServicesReqPojo;
...
public class ServicesController {
	...
	@RequestMapping(value = RestURIConstants.REST_POST_FETCH_SERVICES, method = RequestMethod.POST)
		public @ResponseBody String  login(@RequestBody FetchServicesReqPojo requestBody,HttpSession session) {
