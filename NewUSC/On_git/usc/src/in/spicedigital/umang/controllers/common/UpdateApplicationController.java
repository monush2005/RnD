...
import in.spicedigital.umang.dto.request.EditApplicationReqPojo;
...
public class UpdateApplicationController {
	...
	@RequestMapping(value = RestURIConstants.REST_POST_UPDATE_APPLICATION, method = RequestMethod.POST)
		public @ResponseBody String  login(@RequestBody EditApplicationReqPojo requestBody,HttpSession session) {
			...
			try {
				...
				logger.info("URL: {}",WsConstants.WS_APPLICATION_URL+RestServiceURIConstants.REST_POST_UPDATE_APPLICATION);
				response = restTemplate.postForEntity(WsConstants.WS_APPLICATION_URL+RestServiceURIConstants.REST_POST_UPDATE_APPLICATION, entity,String.class);
