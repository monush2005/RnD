...
import in.spicedigital.umang.dto.request.UpdateUserStatusReqPojo;
...
public class UpdateUserStatusController {
	...
	@RequestMapping(value = RestURIConstants.REST_POST_UPDATE_USER_STATUS, method = RequestMethod.POST)
		public @ResponseBody String  login(@RequestBody UpdateUserStatusReqPojo requestBody,HttpSession session) {
			...
			try {
				...
				logger.info("URL: {}",WsConstants.WS_APPLICATION_URL+RestServiceURIConstants.REST_POST_UPDATE_USER_STATUS);
				response = restTemplate.postForEntity(WsConstants.WS_APPLICATION_URL+RestServiceURIConstants.REST_POST_UPDATE_USER_STATUS, entity,String.class);
