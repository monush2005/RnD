...
@Controller
public class UploadBannerOldController {
	
	private final Logger logger = LoggerFactory.getLogger(this.getClass());
	@Autowired
	private Utility encryptionUtility;

	@RequestMapping(value = RestURIConstants.REST_POST_BANNER_UPLOAD, method = RequestMethod.POST)
		public @ResponseBody String  login(@RequestBody UploadBannerReqPojo requestBody,HttpSession session) {
			...
			try {
				...
				response = restTemplate.postForEntity(WsConstants.WS_APPLICATION_URL+RestServiceURIConstants.REST_POST_BANNER_UPLOAD, entity,String.class);
